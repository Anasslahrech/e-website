...
<div class="container py-2">
    ...
    <form class="mb-3" action="rechercher_commande.php" method="GET">
        <label for="search">Rechercher par ID de commande :</label>
        <input type="text" id="search" name="id_commande" class="form-control" placeholder="Entrez l'ID de la commande">
