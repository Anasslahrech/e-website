...
<div class="container py-2">
    ...
    <div class="mb-3">
        <form class="d-flex" action="rechercher_produits.php" method="GET">
            <input class="form-control me-2" type="search" placeholder="Rechercher produits" aria-label="Search" name="q">
